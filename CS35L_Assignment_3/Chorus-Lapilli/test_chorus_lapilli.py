...
# =========================== [ADD YOUR TESTS HERE] ===========================
    ...
    def test_button_second(self):
        '''Check if the second click results in an O.'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
        self.assertTileIs(tiles[0], self.SYMBOL_BLANK)
        tiles[0].click()
        self.assertTileIs(tiles[0], self.SYMBOL_X)
    ...
    def test_win_con(self):
        '''Check if the marks are not placeable after 6 moves'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
        tiles[0].click()
        tiles[3].click()
        tiles[1].click()
    ...
    def test_center_clause(self):
        '''Check if the center clause invalid move check works as intended'''
        tiles = self.driver.find_elements(By.XPATH, self.BOARD_TILE_XPATH)
        tiles[4].click()
        tiles[0].click()
        tiles[1].click()
